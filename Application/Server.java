...
public class Server implements ActionListener  {
    ...
    Server(){
        ...
        ImageIcon i3 = new ImageIcon(i2);s
    ...
    public static void main(String[] args) {
        ...
        try {
        	...
        	while(true) {                                 //Accepting the user infinite messages
        		Socket s = skt.accept();
        		DataInputStream din = new DataInputStream(s.getInputStream());    //receive msg with respect to Socket
        		dout = new DataOutputStream(s.getOutputStream());                //output msg with respect to Socket
        		
        		while(true) {                              //Infinitely send&receive msg 
        			String msg = din.readUTF();           //reading of message and storing into string msg
        			JPanel  panel = formatLabel(msg);    //displaying message on frame 
        			
        			//Displaying on left of Panel
